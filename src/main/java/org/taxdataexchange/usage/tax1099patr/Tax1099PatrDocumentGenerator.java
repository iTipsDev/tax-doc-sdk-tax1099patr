...
import irs.fdxtax641.jsonserializers.Tax1099PatrSerializer;
import irs.fdxtax641.map2objects.Map2Tax1099Patr;
import org.taxdataexchange.core.pdfbuilders.Tax1099PatrPdfBuilder;
...
public class Tax1099PatrDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099Patr obj = Map2Tax1099Patr.generate( row );
        {
            String asJson = Tax1099PatrSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099Patr.csv";
        ...
        String outputFileName = "Tax1099Patr.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099PatrDocumentGenerator generator = new Tax1099PatrDocumentGenerator( );
